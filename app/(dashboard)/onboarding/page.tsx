  ...
  return (
    <div className="space-y-5">
      <p className="text-sm text-[#6b7280] leading-relaxed">
        AutoPilot needs access to your Google Calendar to automatically create appointments when a
        ...
        <div className="flex items-center gap-3 bg-[#00ff88]/10 border border-[#00ff88]/20 rounded-xl px-5 py-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#6b7280] mt-0.5">
              AutoPilot can now create calendar events automatically.
            </p>
          </div>
        </div>
      ) : (
      ...
      <p className="text-xs text-[#6b7280]">
        AutoPilot only requests permission to read and create calendar events. We never delete or
...
const STEPS = [
  ...
  { number: 6, title: "Call Script", subtitle: "Choose how AutoPilot opens every call", icon: FileText },
    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-4">
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white">AutoPilot Setup</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              {currentStep < STEPS.length ? (
                ...
                >
                  ...
                  {launching ? "Launching…" : "🚀 Launch AutoPilot"}
                </button>
              )}
            </div>
          </div>
